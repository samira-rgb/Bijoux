...
class SearchController extends AbstractController
{
    ...
    public function search(ArticleRepository $repository, Request $request, PaginatorInterface $paginator)
    {
        ...
        // si la requête  retourne un article, l'article est renvoyé vers une page
...
//            );
//        }
        // si plusieurs articles correspondent à la requête, l'article est renvoyé vers le tableau
        // présentant ceux-ci
        else {
